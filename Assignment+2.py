...
def answer_three():
    ...
    token_dict=FreqDist(moby_tokens)
    sorted_token_dict=sorted(token_dict.items(),key=operator.itemgetter(1),reverse=True)
...
def answer_eight():
    ...
    pos_counts=collections.Counter(val[1] for val in pos_token)
...
def answer_eleven(entries=['cormulent', 'incendenece', 'validrate']):
    ...
    return correct# Your answer here 
